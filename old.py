...
print(f'Model trained in {time.perf_counter() - _time:.3f}s')

_time = time.perf_counter()
predictions = model.predict(scaler.transform(X_test))
print(f'Predicions in {time.perf_counter() - _time:.3f}s')
...
print(f"Number of correct families greater than 95%: {correct}")
